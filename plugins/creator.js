...
let name = await conn.getName(who)
 ...
 const ini = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot `, `🚫 Don't call me 🥺`, `⁨leopyth@gmail.com`, `🇮🇩 Indonesia`, `🚀 https://youtube.com/channel/UC2GOH5mCArh3E4J3sGFMC5g`, `nothing`],
